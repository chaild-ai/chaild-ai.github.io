---
title: "Youth PRISM returns to Trinity College"
description: "Our largest session yet, run across parallel breakout rooms"
...
## An academic taster as well as a study
...
3. **Hands-on with [Dynabench](https://dynabench.org/)** — bringing their own task to a chatbot, comparing responses from different models side by side, and talking through how they chose.

Running it as parallel groups required a lot of planning, but it was worth it. Small rooms meant quieter students said more, and researchers could follow a reason as it was being worked out rather than after the fact. It also meant no single conversation dominated — something we noticed in the larger, single-room format.

As with every Youth PRISM session, we collected research data only from students who chose to take part in the research, and we ran the activities for everyone regardless.

Our thanks to Trinity College for hosting us again, and to the students for taking the questions seriously. The findings feed into the wider Youth PRISM study alongside the earlier sessions — you can read [the report from the first one](/static/media/YOUTH-PRISM-2025.pdf) in the meantime.
